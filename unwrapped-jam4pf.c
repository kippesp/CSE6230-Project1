        ...
        B0 = _mm_mul_pd(X0, Y0);
        PREFETCH_T0(&A[a_index_base+32], 256);
        PREFETCH_T0(&B[b_index_base+0+32], 256);
        A0 = _mm_add_pd(A0, B0);
        ...
        B2 = _mm_mul_pd(X0, Y2);
        PREFETCH_T0(&B[b_index_base+128+32], 256);
        PREFETCH_T0(&B[b_index_base+256+32], 256);
        A2 = _mm_add_pd(A2, B2);

        Y3 = _mm_load_pd(&B[b_index_base+384+32]);
        B3 = _mm_mul_pd(X0, Y3);
        PREFETCH_T0(&B[b_index_base+384+32], 256);
        A3 = _mm_add_pd(A3, B3);
        ...
        B0 = _mm_mul_pd(X0, Y0);
        PREFETCH_T0(&A[a_index_base+64], 256);
        PREFETCH_T0(&B[b_index_base+0+64], 256);
        A0 = _mm_add_pd(A0, B0);
        ...
        B2 = _mm_mul_pd(X0, Y2);
        PREFETCH_T0(&B[b_index_base+128+64], 256);
        PREFETCH_T0(&B[b_index_base+256+64], 256);
        A2 = _mm_add_pd(A2, B2);

        Y3 = _mm_load_pd(&B[b_index_base+384+64]);
        B3 = _mm_mul_pd(X0, Y3);
        PREFETCH_T0(&B[b_index_base+384+64], 256);
        A3 = _mm_add_pd(A3, B3);
        ...
        B0 = _mm_mul_pd(X0, Y0);
        PREFETCH_T0(&A[a_index_base+96], 256);
        PREFETCH_T0(&B[b_index_base+0+96], 256);
        A0 = _mm_add_pd(A0, B0);
        ...
        B2 = _mm_mul_pd(X0, Y2);
        PREFETCH_T0(&B[b_index_base+128+96], 256);
        PREFETCH_T0(&B[b_index_base+256+96], 256);
        A2 = _mm_add_pd(A2, B2);

        Y3 = _mm_load_pd(&B[b_index_base+384+96]);
        B3 = _mm_mul_pd(X0, Y3);
        PREFETCH_T0(&B[b_index_base+384+96], 256);
        A3 = _mm_add_pd(A3, B3);
